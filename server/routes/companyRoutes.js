...
// companyRouter.post('/createprofile', authMiddleware, roleCheck(['company']), upload.single('logo'), createProfile);
// companyRouter.post('/createprofile', authMiddleware, roleCheck(['company']), uploadProfilePicture.single('logo'), createProfile);
