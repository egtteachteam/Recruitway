                        ...
                        <div className="row justify-content-center w-100">
                            <div className="col-lg-5">
                                <div className="text-center">
                                    ...
                                    {/* <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/backgrounds/errorimg.svg" alt="Account Verification" className="img-fluid mb-4" /> */}
                                    ...
                                    <Link className="btn btn-primary" to="/login" role="button">Return to Home</Link>
                                </div>
                            </div>
                        </div>
                    </div>
