...
//     // Destructure all candidate data
//     const {
//         fullname,
//         gender,
//         phone,
...
//                                     <p className="text-muted mb-3">{headline}</p>

//                                     <div className="d-flex justify-content-center gap-2 mb-4">
//                                         <span className={`badge bg-${status === 'Active' ? 'success' : 'info'}`}>
//                                             {status}
//                                         </span>
...
//                                         </li>
//                                         <li className="mb-3">
//                                             <h6 className="small text-muted mb-1">Gender</h6>
